  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <a 
  href="#Contact" 
  className='bg-blue-500 px-8 py-3 rounded text-white transition transform duration-200 active:scale-95'
>
  Contact Us
</a>       <img onClick={()=> setShowMobileMenu(true)} src={assets.menu_icon} className='md:hidden w-7 cursor-pointer' alt="" />
      </div>
      {/* --------- mobile-menu------ */}
